...
public class Trait implements ITrait {
	 ...
	 */
	public Trait(ITrait t1, ITrait t2) {
		params = new double[Neat.num_trait_params];
		for (int count = 0; count < Neat.num_trait_params; count++)
			params[count] = (t1.getParams()[count] + t2.getParams()[count]) / 2.0;
		id = t1.getId();
